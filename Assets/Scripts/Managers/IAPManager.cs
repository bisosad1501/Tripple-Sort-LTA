...
public class IAPManager : MonoBehaviour//, IStoreListener
{
    ...
    public void InitializePurchasing()
    {
        ...
        foreach (string iapID in Enum.GetNames(typeof(ConfigPackGame.IAPPackageID)))
        {
    ...
    public void BuyConsumable(ConfigPackGame.IAPPackageID iapID, Action<string, IAP_CALLBACK_STATE> _purchaserManager_Callback)
    {
    ...
    public void BuyNonConsumable(ConfigPackGame.IAPPackageID iapID, Action<string, IAP_CALLBACK_STATE> _purchaserManager_Callback)
    {
        PurchaserManager_Callback = _purchaserManager_Callback;
