...
public class ClearVfx : MonoBehaviour
{
    ...
    public void PlayAnim()
    {
        ...
        transform.DOScale(new Vector3(-2.5f, 2.5f, 2.5f), 0.25f).SetEase(Ease.Linear).OnComplete(() =>
        {
            ...
            transform.DOScale(new Vector3(-4.5f, 4.5f, 4.5f), 0.35f).SetDelay(0.25f).SetEase(Ease.OutQuart);
