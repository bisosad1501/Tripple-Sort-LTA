...
public class SliderView : MonoBehaviour
{
    ...
    public void InitView()
    {
        ...
        arrow.GetComponent<RectTransform>().sizeDelta = new Vector2(witdhScreenSize / 5, 110f);
    ...
    public void ShowNodeByIndex(int index)
    {
        ...
        arrow.DOLocalMoveX(-(currentNodeIndex - index) * (witdhScreenSize/5f), 0.35f).SetRelative(true).SetEase(Ease.InQuad);
